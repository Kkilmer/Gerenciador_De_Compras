...
- botão para `Comparar meses`
- botão para `Mercados cadastrados`

### 2. Cadastro de mercados
...
- mês atual preenchido automaticamente
- seleção do mercado
...
- comparar o mesmo produto entre mercados
- comparar o total do mês entre mercados
- comparar o mesmo produto entre meses

## Regras importantes de negócio

- o mês atual deve ser preenchido automaticamente, mas pode ser editável
- o total do item sempre deve ser recalculado quando quantidade ou preço mudar
- o total geral deve ser a soma de todos os itens
- o nome do mercado deve vir de cadastro prévio
- produtos iguais podem ser agrupados na análise mesmo que tenham sido comprados em meses diferentes
- o sistema deve normalizar nomes de produtos para comparação:
  - converter para lowercase
  - remover espaços extras
  - remover acentos
  - salvar o campo `normalized_name` no banco
- na análise entre meses por produto, o sistema deve calcular:
  - preço médio do mês atual
  - preço médio do mês anterior
  - diferença absoluta
  - diferença percentual
  - classificação: aumentou, diminuiu ou estável
  - lista ordenada por maior aumento

## Observação prática

Para um app real no Android Studio, o caminho mais estável é:

- `Android Studio + Kotlin + WebView + HTML/CSS/JS + Python (Chaquopy)`

Se você quiser, no próximo passo eu posso continuar em uma destas direções:

1. adicionar persistência local com banco
2. criar a tela de comparação mensal
3. montar cadastro completo de mercados
4. adaptar o layout para ficar com aparência mais profissional
